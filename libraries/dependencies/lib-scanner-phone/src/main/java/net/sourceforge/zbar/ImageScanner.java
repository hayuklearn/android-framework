...
public class ImageScanner {
	...
	/**
	 * Enable or disable the inter-image result cache (default disabled). Mostly
	 * useful for scanning video frames, the cache filters duplicate results
	 * from consecutive images, while adding some consistency checking and
	 * hysteresis to the results. Invoking this method also clears the cache.
	 */
	...
	/**
	 * Scan for symbols in provided Image. The image format must currently be
	 * "Y800" or "GRAY".
	 * 
