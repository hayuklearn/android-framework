...
public class IntervalNode {
    ...
    private final List<Intervalable> intervals = new ArrayList<Intervalable>();
    ...
    protected List<Intervalable> checkForOverlapsToTheLeft(Intervalable interval) {
        return checkForOverlaps(interval, IntervalNode.Direction.LEFT);
    }

    protected List<Intervalable> checkForOverlapsToTheRight(Intervalable interval) {
        return checkForOverlaps(interval, IntervalNode.Direction.RIGHT);
    }
