...
public final class Pinyin {
    ...
    private static List<PinyinDict> mPinyinDictList = null;
    ...
    public static void init(Config config) {
        ...
        mPinyinDictList = Collections.unmodifiableList(config.getPinyinDicts());
    ...
    public static void add(PinyinDict dict) {
        ...
        init(new Config(mPinyinDictList).with(dict));
    }
    ...
    public static String toPinyin(String str, String separator) {
        return Engine.toPinyin(str, mTrieDict, mPinyinDictList, separator, mSelector);
    }
    ...
    public static String toPinyin(String str, String separator, PinyinRules rules) {
        if (rules != null) {
            List<PinyinDict> dictList = new ArrayList<>();
            dictList.add(rules.toPinyinMapDict());
            if (mPinyinDictList != null) {
                dictList.addAll(mPinyinDictList);
            }
            Config config = new Config(dictList);
